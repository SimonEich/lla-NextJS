...
type Props = {
  ...
  onSwipeLeft: () => void;
  onSwipeDown: () => void;
  // Exam mode ("Alle Wörter prüfen") only changes the "X Wörter ..." label —
  // the swipe gestures behave exactly like every other mode (right/up master
  // the word outright, left/down mark it "pending"); see exam/page.tsx.
  examMode?: boolean;
};
